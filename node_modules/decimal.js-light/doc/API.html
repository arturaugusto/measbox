...
Decimal.precision                  // 5</pre>
    ...
    <p>
      The default rounding mode used by <a href='#round'><code>round</code></a>,
...
y.ln()                                   // '69.28'</pre>
    ...
    <p>
      ...
      of <code>415</code> digits, meaning that this method can accurately calculate up to a
      precision of about <code>400</code> digits.
    </p>
    <p>
      If more than <code>400</code> digits is required then the precision of <code>LN10</code>
      will need to be increased to <code>15</code> digits more than is required.
    </p>
    <p>
...
y.trunc()                                // '-12'</pre>
    ...
    <table>
      ...
      <tr>
        ...
        <td>exponent</td>
        <td><i>number</i></td>
        <td>Integer, <code>-9007199254740991</code> to <code>9007199254740991</code> inclusive</td>
      </tr>
      <tr>
